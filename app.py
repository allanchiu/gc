...
@app.route("/get_media_url", methods=["GET"])
def get_media_url():
    # Create Rec API Instance
    recordApi = PureCloudPlatformClientV2.RecordingApi(apiclient)
    conversation_id = request.args.get("con_id")  # str | Conversation ID
    max_wait_ms = 10000  # int | The maximum number of milliseconds to wait for the recording to be ready. Must be a positive value. (optional) (default to 5000)
    ...
    try:
        ...
        message = api_response[0].media_uris["0"].media_uri
...
def get_conversation():
    ...
    body.interval = "2025-03-25T00:00:00.000Z/2025-03-25T23:59:59.999Z"
